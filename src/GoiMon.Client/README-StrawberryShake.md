...
dotnet tool install StrawberryShake.Tools --version 15.*
dotnet tool restore
dotnet graphql init http://localhost:5000/graphql -n GoiMonClient -p ./src/GoiMon.Client
```
...
After generation:
- Generated C# client will be in `src/GoiMon.Client/Generated` (as configured).
